// Command Irail-cli is a CLI + REPL for the Irail SDK,
...
const entitiesHelp = "composition connection disturbance liveboard log occupancy station vehicle"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      IRAIL_APIKEY (api key), IRAIL_BASE (base url override)")
