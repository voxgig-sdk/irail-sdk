...
class OccupancyEntity
  ...
  def make
    opts = @_entopts.dup
    OccupancyEntity.new(@_client, opts)
  end
  ...
  # @return [Occupancy, Hash] the current Occupancy data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Occupancy fields)
  def match_get
  ...
  #
  # @param reqdata [OccupancyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Occupancy, Hash] the created Occupancy; raises IrailError on failure
