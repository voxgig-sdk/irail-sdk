...
class LogEntity
  ...
  #
  # @param reqmatch [LogListMatch, Hash, nil] match filter (any subset of
  #   Log fields); defaults to nil, treated as an empty match that lists all.
