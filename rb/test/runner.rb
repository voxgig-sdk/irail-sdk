...
module IrailTestRunner
  ...
  def self.env_override(m)
    live = getenv("IRAIL_TEST_LIVE")
    override = getenv("IRAIL_TEST_OVERRIDE")
    ...
    explain = getenv("IRAIL_TEST_EXPLAIN")
    m["IRAIL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = IrailTestRunner
Helpers = IrailHelpers
Vs = VoxgigStruct
