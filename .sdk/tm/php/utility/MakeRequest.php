...
// Irail SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IrailMakeRequest
{
    public static function call(IrailContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IrailResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IrailResponse($fetched);
        } else {
