...
class IrailClienttrackFeature extends IrailBaseFeature
{
    ...
    public function PostConstruct(IrailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Irail-SDK';
