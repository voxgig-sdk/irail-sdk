...
// Irail SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IrailTestFeature extends IrailBaseFeature
{
    ...
    public function init(IrailContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IrailContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IrailContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IrailContext $ctx, $op, $args): array
    {
