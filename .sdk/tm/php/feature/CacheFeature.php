...
class IrailCacheFeature extends IrailBaseFeature
{
    ...
    private function _through(IrailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
