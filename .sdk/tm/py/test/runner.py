...
class IrailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IrailTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IrailTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IrailTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
