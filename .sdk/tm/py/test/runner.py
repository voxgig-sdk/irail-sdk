...
class IrailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IrailTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IrailTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IrailTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
