...
from projectname_sdk import IrailSDK
from projectname_sdk.core.spec import IrailSpec
from projectname_sdk.core.result import IrailResult
from projectname_sdk.core.response import IrailResponse
from projectname_sdk.core.operation import IrailOperation
from projectname_sdk.core.error import IrailError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IrailBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = IrailSDK.test(None, None)
        ...
        class TestInitFeature(IrailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IrailBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IrailSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IrailSDK.test(None, setup_opts)
