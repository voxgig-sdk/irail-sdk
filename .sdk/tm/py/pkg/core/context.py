...
from projectname_sdk.core.control import IrailControl
...
class IrailContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, IrailResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IrailError(code, msg, self)
