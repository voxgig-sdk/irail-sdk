...
|---|---|---|
| `ts/` | @voxgig-sdk/irail-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/irail-sdk \
      --repository voxgig-sdk/irail-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/irail-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/irail-sdk --id=<id>` removes one.
