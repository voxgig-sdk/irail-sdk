...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/irail` | `npm install @voxgig-sdk/irail` |
| Python | `voxgig-sdk-irail` | `pip install voxgig-sdk-irail` |
| PHP | `voxgig-sdk/irail` | `composer require voxgig-sdk/irail` |
| Golang | `github.com/voxgig-sdk/irail-sdk/go` | `go get github.com/voxgig-sdk/irail-sdk/go` |
| Ruby | `voxgig-sdk-irail` | `gem install voxgig-sdk-irail` |
| Lua | `voxgig-sdk-irail` | `luarocks install voxgig-sdk-irail` |
