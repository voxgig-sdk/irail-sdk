...
| Python | `voxgig-sdk-irail-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/irail-sdk/tags) |
| PHP | `voxgig-sdk/irail-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/irail-sdk/tags) |
| Golang | `github.com/voxgig-sdk/irail-sdk/go` | `go get github.com/voxgig-sdk/irail-sdk/go@latest` |
| Ruby | `voxgig-sdk-irail-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/irail-sdk/tags) |
| Lua | `voxgig-sdk-irail-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/irail-sdk/tags) |
