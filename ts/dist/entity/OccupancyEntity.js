...
exports.OccupancyEntity = void 0;
const IrailEntityBase_1 = require("../IrailEntityBase");
class OccupancyEntity extends IrailEntityBase_1.IrailEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'occupancy';
        this.name_ = 'occupancy';
        this.Name = 'Occupancy';
    }
    make() {
        return new OccupancyEntity(this._client, this.entopts());
    }
...
exports.OccupancyEntity = OccupancyEntity;
//# sourceMappingURL=OccupancyEntity.js.map