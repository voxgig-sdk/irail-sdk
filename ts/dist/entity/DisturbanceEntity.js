...
class DisturbanceEntity extends IrailEntityBase_1.IrailEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'disturbance';
        this.name_ = 'disturbance';
        this.Name = 'Disturbance';
    }
    make() {
        return new DisturbanceEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Disturbance[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.DisturbanceEntity = DisturbanceEntity;
//# sourceMappingURL=DisturbanceEntity.js.map