...
exports.LiveboardEntity = void 0;
const IrailEntityBase_1 = require("../IrailEntityBase");
class LiveboardEntity extends IrailEntityBase_1.IrailEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'liveboard';
        this.name_ = 'liveboard';
        this.Name = 'Liveboard';
    }
    make() {
        return new LiveboardEntity(this._client, this.entopts());
    }
...
exports.LiveboardEntity = LiveboardEntity;
//# sourceMappingURL=LiveboardEntity.js.map