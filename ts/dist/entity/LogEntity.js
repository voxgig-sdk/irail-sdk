...
class LogEntity extends IrailEntityBase_1.IrailEntityBase {
    ...
    make() {
        return new LogEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Log[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
