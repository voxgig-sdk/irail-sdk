...
class StationEntity extends IrailEntityBase<Station> {
  ...
  make(this: StationEntity) {
    return new StationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: StationLoadMatch, ctrl?: Control): Promise<StationEntity> {
