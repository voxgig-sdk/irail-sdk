...
class IrailSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('IrailSDK: graphql: ' +
  ...
  Composition(entopts?: Record<string, any>) {
    const self = this
    return new CompositionEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Disturbance(entopts?: Record<string, any>) {
    const self = this
    return new DisturbanceEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Liveboard(entopts?: Record<string, any>) {
    const self = this
    return new LiveboardEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Occupancy(entopts?: Record<string, any>) {
    const self = this
    return new OccupancyEntity(self, entopts)
  }
