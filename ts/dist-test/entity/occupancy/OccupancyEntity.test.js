...
(0, node_test_1.describe)('OccupancyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'occupancy.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != occupancy_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/occupancy/OccupancyTestData.json');
    ...
    let idmap = transform(['occupancy01', 'occupancy02', 'occupancy03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['IRAIL_TEST_OCCUPANCY_ENTID'];
...
//# sourceMappingURL=OccupancyEntity.test.js.map