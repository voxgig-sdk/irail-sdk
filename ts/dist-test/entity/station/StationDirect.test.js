...
(0, node_test_1.describe)('StationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-station', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-station', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IRAIL_TEST_STATION_ENTID'];
...
//# sourceMappingURL=StationDirect.test.js.map