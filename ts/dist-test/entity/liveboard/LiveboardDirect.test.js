...
(0, node_test_1.describe)('LiveboardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-liveboard', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-liveboard', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IRAIL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IrailSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IRAIL_TEST_LIVEBOARD_ENTID'];
...
//# sourceMappingURL=LiveboardDirect.test.js.map