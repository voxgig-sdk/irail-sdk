...
(0, node_test_1.describe)('CompositionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-composition', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-composition', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IRAIL_TEST_COMPOSITION_ENTID'];
...
//# sourceMappingURL=CompositionDirect.test.js.map