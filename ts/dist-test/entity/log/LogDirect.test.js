...
(0, node_test_1.describe)('LogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-log', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-log', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IRAIL_TEST_LOG_ENTID'];
...
//# sourceMappingURL=LogDirect.test.js.map