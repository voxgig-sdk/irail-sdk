# Irail TypeScript SDK

The TypeScript SDK for the Irail API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| Method | Returns | Description |
| --- | --- | --- |
| `IrailSDK.test(testopts?, sdkopts?)` | `IrailSDK` | Create a test-mode client. |
