...
from irail_sdk.utility import register

# Load features
from irail_sdk.feature.base_feature import IrailBaseFeature
from irail_sdk.features import _has_feature, _make_feature
...
class IrailSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "IrailSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IrailSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Composition(self, data=None) -> "CompositionEntity":
        ...
        from irail_sdk.entity.composition_entity import CompositionEntity
    ...
    def Connection(self, data=None) -> "ConnectionEntity":
        ...
        from irail_sdk.entity.connection_entity import ConnectionEntity
    ...
    def Disturbance(self, data=None) -> "DisturbanceEntity":
        ...
        from irail_sdk.entity.disturbance_entity import DisturbanceEntity
    ...
    def Occupancy(self, data=None) -> "OccupancyEntity":
        ...
        from irail_sdk.entity.occupancy_entity import OccupancyEntity
    ...
    def Station(self, data=None) -> "StationEntity":
        ...
        from irail_sdk.entity.station_entity import StationEntity
    ...
    def Vehicle(self, data=None) -> "VehicleEntity":
        ...
        from irail_sdk.entity.vehicle_entity import VehicleEntity
