...
class OccupancyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OccupancyEntity(self._client, opts)
    ...
    def create(self, reqdata: OccupancyCreateData, ctrl=None) -> Occupancy:
        utility = self._utility
