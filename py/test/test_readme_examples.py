# Irail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IrailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IrailSDK(...) and IrailSDK.test(...) become
#      IrailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
