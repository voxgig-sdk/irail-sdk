...
class IrailProxyFeature extends IrailBaseFeature
{
    ...
    public function init(IrailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IrailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
