...
class IrailStreamingFeature extends IrailBaseFeature
{
    ...
    private function _iterate(IrailResult $result): \Generator
    {
    ...
    private function _streamable(IrailContext $ctx): bool
    {
