...
class IrailRbacFeature extends IrailBaseFeature
{
    ...
    private function _required(IrailContext $ctx): ?string
    {
    ...
    private function _reject(IrailContext $ctx, string $required): void
    {
    ...
    private function _track(IrailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
