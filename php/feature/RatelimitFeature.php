...
class IrailRatelimitFeature extends IrailBaseFeature
{
    ...
    private function _acquire(IrailContext $ctx): void
    {
    ...
    private function _track(IrailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
