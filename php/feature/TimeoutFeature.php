...
class IrailTimeoutFeature extends IrailBaseFeature
{
    ...
    private function _with_timeout(IrailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IrailContext $_ctx, float $ms): void
    {
        $client = $this->client;
