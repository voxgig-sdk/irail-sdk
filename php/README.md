...
The PHP SDK for the Irail API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Composition(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Irail(null)->load(
    ["id" => "test01"], null
);
