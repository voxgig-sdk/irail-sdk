...
class ConnectionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IRAIL_TEST_CONNECTION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function connection_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IRAIL_TEST_CONNECTION_ENTID");
