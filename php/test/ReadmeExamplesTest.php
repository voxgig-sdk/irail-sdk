...
// Irail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IrailSDK::test)
...
{
    private const SDK_CLASS = 'IrailSDK';
    ...
    private const SDK_BASE = 'irail_sdk';
