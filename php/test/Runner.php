...
class IrailTestRunner
{
    ...
    {
        $live = self::getenv('IRAIL_TEST_LIVE');
        $override = self::getenv('IRAIL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IRAIL_TEST_EXPLAIN');
...
class_alias('IrailTestRunner', 'Runner');
class_alias('IrailHelpers', 'Helpers');
