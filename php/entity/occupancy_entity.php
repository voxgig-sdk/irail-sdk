...
class OccupancyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OccupancyEntity($this->_client, $opts);
    }

    /**
     * @param Occupancy|array $args Occupancy data (assoc-array) to store.
     */
    ...
    /**
     * @return Occupancy|array The current Occupancy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Occupancy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Occupancy fields).
     */
     ...
     *
     * @param OccupancyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OccupancyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Occupancy|array The created Occupancy as an assoc-array at the
