...
local CompositionEntity = {}
CompositionEntity.__index = CompositionEntity


function CompositionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CompositionEntity)
...
function CompositionEntity:get_name()
  return self._name
end


function CompositionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CompositionEntity.new(self._client, opts)
end
...
function CompositionEntity:mark_deleted()
  self._deleted = true
end


function CompositionEntity:deleted()
  return true == self._deleted
end


function CompositionEntity:data_set(args)
  if args ~= nil then
...
function CompositionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CompositionEntity:match_set(args)
  if args ~= nil then
...
function CompositionEntity:match_get()
...
function CompositionEntity:stream(action, args, callopts)
...
function CompositionEntity:_run_op(ctx, post_done)
  local utility = self._utility
