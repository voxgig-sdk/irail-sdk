...
describe("CompositionDirect", function()
  it("should direct-load-composition", function()
    local setup = composition_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-composition", setup.live and "live" or "unit")
