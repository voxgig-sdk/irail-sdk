...
-- data to return.
local TEST_SEED = '{ entity = { ["composition"] = { ["test01"] = { id = "test01" } }, ["connection"] = { ["test01"] = { id = "test01" } }, ["disturbance"] = { ["test01"] = { id = "test01" } }, ["liveboard"] = { ["test01"] = { id = "test01" } }, ["log"] = { ["test01"] = { id = "test01" } }, ["occupancy"] = { ["test01"] = { id = "test01" } }, ["station"] = { ["test01"] = { id = "test01" } }, ["vehicle"] = { ["test01"] = { id = "test01" } } } }'
