...
describe("LogDirect", function()
  it("should direct-list-log", function()
    local setup = log_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-log", setup.live and "live" or "unit")
