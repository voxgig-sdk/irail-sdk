...
describe("LiveboardDirect", function()
  it("should direct-load-liveboard", function()
    local setup = liveboard_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-liveboard", setup.live and "live" or "unit")
