...
describe("StationDirect", function()
  it("should direct-load-station", function()
    local setup = station_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-station", setup.live and "live" or "unit")
