...
describe("DisturbanceDirect", function()
  it("should direct-list-disturbance", function()
    local setup = disturbance_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-disturbance", setup.live and "live" or "unit")
