...
## Install
```bash
go get github.com/voxgig-sdk/irail-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/irail-sdk=../path/to/github.com/voxgig-sdk/irail-sdk
```
...
```
github.com/voxgig-sdk/irail-sdk/
...
The root package (`github.com/voxgig-sdk/irail-sdk`) re-exports everything needed
