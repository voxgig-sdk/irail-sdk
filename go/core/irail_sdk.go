...
func (sdk *IrailSDK) OptionsMap() map[string]any {
...
func (sdk *IrailSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IrailSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IrailSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IrailSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IrailSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IrailSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IrailSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IrailSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IrailSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IrailSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
