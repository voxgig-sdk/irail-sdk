...
const testSeed = `map[string]any{"entity": map[string]any{"composition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "disturbance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "liveboard": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "log": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "occupancy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "station": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vehicle": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
