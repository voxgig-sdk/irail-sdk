...
func NewCompositionEntity(client *core.IrailSDK, entopts map[string]any) *CompositionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompositionEntity) GetName() string { return e.name }
...
func (e *CompositionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompositionEntity) Deleted() bool {
	return e.deleted
}


func (e *CompositionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompositionEntity(e.client, opts)
}

func (e *CompositionEntity) Data(args ...any) any {
...
func (e *CompositionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Composition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompositionEntity) DataTyped(data ...Composition) Composition {
	if len(data) > 0 {
		return typedFrom[Composition](e.Data(asMap(data[0])))
	}
	return typedFrom[Composition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Composition (all fields
// optional at the wire level).
func (e *CompositionEntity) MatchTyped(match ...Composition) Composition {
	if len(match) > 0 {
		return typedFrom[Composition](e.Match(asMap(match[0])))
	}
	return typedFrom[Composition](e.Match())
}
...
func (e *CompositionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompositionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompositionLoadMatch and returns an Composition. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CompositionEntity) LoadTyped(reqmatch CompositionLoadMatch, ctrl map[string]any) (Composition, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Composition{}, err
	}
	return typedFrom[Composition](res), nil
}



func (e *CompositionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CompositionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompositionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompositionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompositionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
