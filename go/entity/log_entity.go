...
func NewLogEntity(client *core.IrailSDK, entopts map[string]any) *LogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LogEntity) GetName() string { return e.name }
...
func (e *LogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LogEntity) Deleted() bool {
	return e.deleted
}


func (e *LogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLogEntity(e.client, opts)
}

func (e *LogEntity) Data(args ...any) any {
...
func (e *LogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *LogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LogEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *LogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
