...
func NewLiveboardEntity(client *core.IrailSDK, entopts map[string]any) *LiveboardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LiveboardEntity) GetName() string { return e.name }
...
func (e *LiveboardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LiveboardEntity) Deleted() bool {
	return e.deleted
}


func (e *LiveboardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLiveboardEntity(e.client, opts)
}

func (e *LiveboardEntity) Data(args ...any) any {
...
func (e *LiveboardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Liveboard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LiveboardEntity) DataTyped(data ...Liveboard) Liveboard {
	if len(data) > 0 {
		return typedFrom[Liveboard](e.Data(asMap(data[0])))
	}
	return typedFrom[Liveboard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Liveboard (all fields
// optional at the wire level).
func (e *LiveboardEntity) MatchTyped(match ...Liveboard) Liveboard {
	if len(match) > 0 {
		return typedFrom[Liveboard](e.Match(asMap(match[0])))
	}
	return typedFrom[Liveboard](e.Match())
}
...
func (e *LiveboardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LiveboardEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LiveboardLoadMatch and returns an Liveboard. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LiveboardEntity) LoadTyped(reqmatch LiveboardLoadMatch, ctrl map[string]any) (Liveboard, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Liveboard{}, err
	}
	return typedFrom[Liveboard](res), nil
}



func (e *LiveboardEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LiveboardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LiveboardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LiveboardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LiveboardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
