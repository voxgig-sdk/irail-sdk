...
func NewOccupancyEntity(client *core.IrailSDK, entopts map[string]any) *OccupancyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OccupancyEntity) GetName() string { return e.name }
...
func (e *OccupancyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OccupancyEntity) Deleted() bool {
	return e.deleted
}


func (e *OccupancyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOccupancyEntity(e.client, opts)
}

func (e *OccupancyEntity) Data(args ...any) any {
...
func (e *OccupancyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Occupancy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OccupancyEntity) DataTyped(data ...Occupancy) Occupancy {
	if len(data) > 0 {
		return typedFrom[Occupancy](e.Data(asMap(data[0])))
	}
	return typedFrom[Occupancy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Occupancy (all fields
// optional at the wire level).
func (e *OccupancyEntity) MatchTyped(match ...Occupancy) Occupancy {
	if len(match) > 0 {
		return typedFrom[Occupancy](e.Match(asMap(match[0])))
	}
	return typedFrom[Occupancy](e.Match())
}
...
func (e *OccupancyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OccupancyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *OccupancyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OccupancyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OccupancyCreateData and returns an Occupancy. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OccupancyEntity) CreateTyped(reqdata OccupancyCreateData, ctrl map[string]any) (Occupancy, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Occupancy{}, err
	}
	return typedFrom[Occupancy](res), nil
}



func (e *OccupancyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OccupancyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OccupancyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
