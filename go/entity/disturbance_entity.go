...
type DisturbanceEntity struct {
	name    string
	client  *core.IrailSDK
...
func NewDisturbanceEntity(client *core.IrailSDK, entopts map[string]any) *DisturbanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DisturbanceEntity) GetName() string { return e.name }
...
func (e *DisturbanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DisturbanceEntity) Deleted() bool {
	return e.deleted
}


func (e *DisturbanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDisturbanceEntity(e.client, opts)
}

func (e *DisturbanceEntity) Data(args ...any) any {
...
func (e *DisturbanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Disturbance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DisturbanceEntity) DataTyped(data ...Disturbance) Disturbance {
	if len(data) > 0 {
		return typedFrom[Disturbance](e.Data(asMap(data[0])))
	}
	return typedFrom[Disturbance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Disturbance (all fields
// optional at the wire level).
func (e *DisturbanceEntity) MatchTyped(match ...Disturbance) Disturbance {
	if len(match) > 0 {
		return typedFrom[Disturbance](e.Match(asMap(match[0])))
	}
	return typedFrom[Disturbance](e.Match())
}
...
func (e *DisturbanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DisturbanceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DisturbanceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DisturbanceListMatch and returns []Disturbance. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DisturbanceEntity) ListTyped(reqmatch DisturbanceListMatch, ctrl map[string]any) ([]Disturbance, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Disturbance](res), nil
}



func (e *DisturbanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DisturbanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DisturbanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DisturbanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
