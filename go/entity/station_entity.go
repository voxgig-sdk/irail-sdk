...
func NewStationEntity(client *core.IrailSDK, entopts map[string]any) *StationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StationEntity) GetName() string { return e.name }
...
func (e *StationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StationEntity) Deleted() bool {
	return e.deleted
}


func (e *StationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStationEntity(e.client, opts)
}

func (e *StationEntity) Data(args ...any) any {
...
func (e *StationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Station; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StationEntity) DataTyped(data ...Station) Station {
	if len(data) > 0 {
		return typedFrom[Station](e.Data(asMap(data[0])))
	}
	return typedFrom[Station](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Station (all fields
// optional at the wire level).
func (e *StationEntity) MatchTyped(match ...Station) Station {
	if len(match) > 0 {
		return typedFrom[Station](e.Match(asMap(match[0])))
	}
	return typedFrom[Station](e.Match())
}
...
func (e *StationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StationLoadMatch and returns an Station. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StationEntity) LoadTyped(reqmatch StationLoadMatch, ctrl map[string]any) (Station, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Station{}, err
	}
	return typedFrom[Station](res), nil
}



func (e *StationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
